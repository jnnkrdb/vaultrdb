...
type VRDBSecretSpec struct {
	...
	// Foo is an example field of VRDBSecret. Edit vrdbsecret_types.go to remove/update
	Foo string `json:"foo,omitempty"`
}

// VRDBSecretStatus defines the observed state of VRDBSecret
type VRDBSecretStatus struct {
...
type VRDBSecret struct {
	...
	Status VRDBSecretStatus `json:"status,omitempty"`
}
